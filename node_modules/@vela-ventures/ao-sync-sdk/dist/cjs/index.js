...
const beacon_version_1 = require("./constants/beacon-version");
class WalletClient {
    ...
    async handleConnectResponse(packet) {
        ...
        if (buffer_1.Buffer.isBuffer(packet.payload)) {
            ...
            try {
                ...
                if (!this.isVersionValid(clientVersion, beacon_version_1.BEACON_MIN_VERSION)) {
                    (0, templates_1.createModalTemplate)({
                        subTitle: `Warning`,
                        description: `The minimum supported version is ${beacon_version_1.BEACON_MIN_VERSION}, and some features may not work as expected. Please update to the latest version of the app for the best experience.`,
                        animationData: false,
                    });
                }
            }
