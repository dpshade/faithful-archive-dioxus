...
`;
export const createModalTemplate = ({ subTitle, description, qrCodeData, animationData, autoClose, walletClient, }) => {
...
export function connectionModalMessage(modalMessage) {
